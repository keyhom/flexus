...
public class DateUtil {
     ...
     * @tiptext
     */
    static public function compareDates(d1:Date, d2:Date):int {
     ...
     *
     * @param d The Date from which to generate the 12 hour clock indicator.
     *
     ...
     * @tiptext
     */
    static public function getAMPM(d:Date):String {
     ...
     * @see FULL_DAY
     */
    static public function getFullDayIndex(d:String):int {
     ...
     * @see FULL_DAY
     */
    static public function getFullDayName(d:Date):String {
     ...
     * @see FULL_MONTH
     */
    static public function getFullMonthIndex(m:String):int {
     ...
     * @see FULL_MONTH
     */
    static public function getFullMonthName(d:Date):String {
     ...
     * @see SHORT_DAY
     */
    static public function getShortDayIndex(d:String):int {
     ...
     * @see SHORT_DAY
     */
    static public function getShortDayName(d:Date):String {
     ...
     * will be returned.
     *
     * @param d The Date from which to generate the short hour
     *
     ...
     * @tiptext
     */
    static public function getShortHour(d:Date):int {
        var h:int = d.hours;
     ...
     * @see SHORT_MONTH
     */
    static public function getShortMonthIndex(m:String):int {
     ...
     * @see SHORT_MONTH
     */
    static public function getShortMonthName(d:Date):String {
     ...
     * @tiptext
     */
    static public function getShortYear(d:Date):String {
     ...
     */
    static public function getUTCDate(d:Date):Date {
     ...
     */
    static public function makeMorning(d:Date):Date {
     ...
     */
    static public function makeNight(d:Date):Date {
        var d:Date = new Date(d.time);
        d.hours = 23;
        d.minutes = 59;
        d.seconds = 59;
     ...
     */
    static public function parseRFC822(str:String):Date {
        var finalDate:Date;
        try {
            ...
            var month:Number = Number(DateUtil.getShortMonthIndex(dateParts.
                    shift()));
            ...
            var second:Number = (timeParts.length > 0) ? int(timeParts.shift()) :
                    0;

            var milliseconds:Number = Date.UTC(year, month, date, hour, minute,
                    second, 0);
     ...
     */
    static public function parseW3CDTF(str:String):Date {
        var finalDate:Date;
        try {
            ...
            if (timeStr.indexOf("Z") != -1) {
                ...
                multiplier = 1;
                offsetStr = timeStr.substring(timeStr.indexOf("+") + 1, timeStr.
                        length);
                offsetHours = Number(offsetStr.substring(0, offsetStr.indexOf(":")));
                offsetMinutes = Number(offsetStr.substring(offsetStr.indexOf(":") +
                        1, offsetStr.length));
            ...
            var secondsArr:Array = (timeArr.length > 0) ? String(timeArr.shift()).
                    split(".") : null;
            ...
            var milliseconds:Number = (secondsArr != null && secondsArr.length >
                    0) ? 1000 * parseFloat("0." + secondsArr.shift()) : 0;
     ...
     * @see http://asg.web.cmu.edu/rfc/rfc822.html
     */
    static public function toRFC822(d:Date):String {
     ...
     * @see http://www.w3.org/TR/NOTE-datetime
     */
    static public function toW3CDTF(d:Date, includeMilliseconds:Boolean = false):String {
        var date:Number = d.getUTCDate();
