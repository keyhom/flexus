...
public class JPGEncoder
{
	...
	private function RGB2YUV(img:BitmapData, xpos:int, ypos:int):void
	{
		...
		for (var y:int = 0; y < 8; y++)
		{
			for (var x:int = 0; x < 8; x++)
			{
				...
				YDU[pos] = (((0.29900) * R + (0.58700) * G + (0.11400) * B)) -
					128;
	...
	private function fDCTQuant(data:Array, fdtbl:Array):Array
	{
		var tmp0:Number, tmp1:Number, tmp2:Number, tmp3:Number, tmp4:Number,
			tmp5:Number, tmp6:Number, tmp7:Number;
		var tmp10:Number, tmp11:Number, tmp12:Number, tmp13:Number;
		var z1:Number, z2:Number, z3:Number, z4:Number, z5:Number, z11:Number,
			z13:Number;
		var i:int;
		/* Pass 1: process rows. */
		var dataOff:int = 0;
	...
	private function processDU(CDU:Array, fdtbl:Array, DC:Number, HTDC:Array,
							   HTAC:Array):Number
	{
